...
import {onDOMContentLoaded} from "../../app/assets/javascripts/produceApiUploadOas.js";
...
describe('onDOMContentLoaded', () => {
    ...
    function selectFileUsingDialog(file) {
        const elFilesInput = document.getElementById('oasFile');
