...
import models.api.{ApiDeploymentStatuses, ApiDetail, CompactApiDetail, PlatformContact}
...
class ApiHubService @Inject()(
  ...
  def getApis(platform: Option[String] = None)(implicit hc: HeaderCarrier): Future[Seq[CompactApiDetail]] = {
  ...
  def getUserApis(teamMember: TeamMember)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Seq[CompactApiDetail]] = {
