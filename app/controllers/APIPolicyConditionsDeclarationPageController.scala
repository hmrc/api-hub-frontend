...
import pages.{ApiPolicyConditionsDeclarationPage, AddAnApiApiIdPage}
...
class ApiPolicyConditionsDeclarationPageController @Inject()(
  ...
  private def buildView(mode: Mode, form: Form[Set[ApiPolicyConditionsDeclaration]], status: Status)(implicit request: DataRequest[AnyContent]):Future[Result] = {
