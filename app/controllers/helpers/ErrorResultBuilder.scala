...
class ErrorResultBuilder @Inject()(
  ...
  def badRequest()(implicit request: BaseRequest[?]): Result = {
    badRequest(None, None, None)
  }

  def badRequest(message: String)(implicit request: BaseRequest[?]): Result = {
    badRequest(None, None, Some(message))
  }

  def badRequest(heading: String, message: String)(implicit request: BaseRequest[?]): Result = {
    badRequest(None, Some(heading), Some(message))
  }

  def badRequest(title: String, heading: String, message: String)(implicit request: BaseRequest[?]): Result = {
    badRequest(Some(title), Some(heading), Some(message))
  }

  private def badRequest(title: Option[String], heading: Option[String], message: Option[String])(implicit request: BaseRequest[?]): Result = {
    BadRequest(
  ...
  def notFound()(implicit request: BaseRequest[?]): Result = {
    notFound(None, None, None)
  }

  def notFound(message: String)(implicit request: BaseRequest[?]): Result = {
    notFound(None, None, Some(message))
  }

  def notFound(heading: String, message: String)(implicit request: BaseRequest[?]): Result = {
    notFound(None, Some(heading), Some(message))
  }

  def applicationNotFound(id: String)(implicit request: BaseRequest[?]): Result = {
    notFound(
  ...
  def apiNotFound(id: String)(implicit request: BaseRequest[?]): Result = {
    notFound(
  ...
  def apiNotFoundInApim(apiDetail: ApiDetail)(implicit request: BaseRequest[?]): Result = {
    notFound(
      Messages("site.apiNotFound.heading"),
  ...
  def apiNotFoundInApplication(apiTitle: String, application: Application)(implicit request: BaseRequest[?]): Result = {
    notFound(
      Messages("site.apiNotFound.heading"),
  ...
  def apiNotFoundInApplication(apiDetail: ApiDetail, application: Application)(implicit request: BaseRequest[?]): Result = {
    apiNotFoundInApplication(apiDetail.title, application)
  }

  def accessRequestNotFound(id: String)(implicit request: BaseRequest[?]): Result = {
    notFound(
  ...
  def teamNotFound(teamId: String)(implicit request: BaseRequest[?]): Result = {
    notFound(
  ...
  def environmentNotFound(environment: String)(implicit request: BaseRequest[?]): Result =
    notFound(
  ...
  private def notFound(title: Option[String], heading: Option[String], message: Option[String])(implicit request: BaseRequest[?]): Result = {
    NotFound(
      logAndBuildErrorTemplate(
        NOT_FOUND,
  ...
  def internalServerError(t: Throwable)(implicit request: BaseRequest[?]): Result = {
    logger.warn("Internal server error", t)
    internalServerError()
  }

  def internalServerError(message: String, t: Throwable)(implicit request: BaseRequest[?]): Result = {
    logger.warn("Internal server error", t)
    internalServerError(Some(message))
  }

  private def internalServerError(message: Option[String] = None)(implicit request: BaseRequest[?]): Result = {
    InternalServerError(
      logAndBuildErrorTemplate(
  ...
  private def logAndBuildErrorTemplate(status: Int, title: String, heading: String, message: String)(implicit request: BaseRequest[?]) = {
