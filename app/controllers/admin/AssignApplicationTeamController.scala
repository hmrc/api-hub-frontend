...
@Singleton
class AssignApplicationTeamController @Inject() (
  override val controllerComponents: MessagesControllerComponents,
  identify: IdentifierAction,
  isSupport: AuthorisedSupportAction,
  view: AssignApplicationTeamView
) extends FrontendBaseController with I18nSupport {

  def onPageLoad(applicationId: String): Action[AnyContent] = (identify andThen isSupport) {
    implicit request =>
