...
object ProduceApiHowToCreateSummary  {

  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(ProduceApiHowToCreatePage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          value   = value,
          actions = Seq(
            ActionItemViewModel("site.change", controllers.myapis.produce.routes.ProduceApiHowToCreateController.onPageLoad(CheckMode).url)
