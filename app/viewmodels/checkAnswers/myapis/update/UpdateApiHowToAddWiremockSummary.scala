...
object UpdateApiHowToAddWiremockSummary  {

  def row(answers: UserAnswers)(implicit messages: Messages): Option[SummaryListRow] =
    answers.get(UpdateApiHowToAddWiremockPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          value   = value,
          actions = Seq(
            ActionItemViewModel("site.change", controllers.myapis.update.routes.UpdateApiHowToAddWiremockController.onPageLoad(CheckMode).url)
