    ...
    answers.get(RegisterApplicationTeamPage).map {
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          value   = value,
          actions = Seq(
            ActionItemViewModel("site.change", controllers.application.register.routes.RegisterApplicationTeamController.onPageLoad(CheckMode).url)
