...
case class ApplicationApi(apiId: String, apiTitle: String, totalEndpoints: Int, endpoints: Seq[ApplicationEndpoint], hasPendingAccessRequest: Boolean, isMissing: Boolean) {
