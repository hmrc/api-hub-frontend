    ...
    "must deserialise valid values" in {
      ...
      forAll(gen) {
        produceApiHowToCreate =>
          ...
          JsString(produceApiHowToCreate.toString).validate[ProduceApiHowToCreate].asOpt.value mustEqual produceApiHowToCreate
      }
    }
    ...
    "must serialise" in {
      ...
      forAll(gen) {
        produceApiHowToCreate =>
          ...
          Json.toJson(produceApiHowToCreate) mustEqual JsString(produceApiHowToCreate.toString)
      }
    }
  }
}
