...
class ProduceApiEnterWiremockControllerSpec extends SpecBase with MockitoSugar {
  ...
  "ProduceApiEnterWiremock Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(fixture.application) {
        val request = FakeRequest(GET, produceApiEnterWiremockRoute)
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ProduceApiEnterWiremockPage, "wiremock").success.value
