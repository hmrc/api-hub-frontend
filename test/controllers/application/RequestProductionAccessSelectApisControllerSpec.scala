  ...
  "RequestProductionAccessSelectApis Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(form, NormalMode, Seq(applicationApi), Seq(applicationApiPendingRequest))(request, messages(application)).toString
      }
    }
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill(Set(applicationApi.apiId)), NormalMode, Seq(applicationApi), Seq(applicationApiPendingRequest))(request, messages(application)).toString
      }
    }
    ...
    "must return a Bad Request and errors when invalid data is submitted" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual view(boundForm, NormalMode,  Seq(applicationApi), Seq(applicationApiPendingRequest))(request, messages(application)).toString
      }
    }
...
//      .build()
//
//    Fixture(application, applicationApiBuilder)
//
